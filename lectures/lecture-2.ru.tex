...
\end{equation*}
\begin{enumerate}
    \item Какое априорное распределение взять для $A$?
    \item Какое априорное распределение взять для $\beta$?
    \item Какое априорное предиктивное распределение для $Y_{g=0}$?
\end{enumerate}
\end{frame}

...
% НОВОЕ про языковые модели
\begin{frame}{Использование языковых моделей}
    Использование LLM допускается. Бесплатный доступ к LLM:
    \begin{itemize}
        \item \href{https://chat.deepseek.com/}{https://chat.deepseek.com/}
        \item \href{https://www.kimi.com/}{https://www.kimi.com/}
        \item \href{https://qwen.ai/}{https://qwen.ai/}
        \item \href{https://giga.chat/}{https://giga.chat/}
    \end{itemize}
    Как улучшить качество работы:
    \begin{itemize}
        \item Главное -- подробно описать задачу: входные данные, требования, ожидаемый результат.
        \item Включить DeepThink и онлайн поиск.
        \item Добавить в промпт ссылку на документацию PyMC.
        \item Kimi умеет не только писать, но и \emph{выполнять} код на Питоне.
    \end{itemize}
\end{frame}
% НОВОЕ про языковые модели
...
\begin{itemize}
    ...
    \item<+-> Для принятия информированного решения необходимы статистические методы %Statistics is required for an informed decision
\end{itemize}
\end{frame}
\begin{frame}{Игра}
    \begin{figure}
...
Измерение наличия и степени употребления марихуаны %Measuring the existence and severity of cannabis usage
    \begin{itemize}
        ...
        \item Результаты сравниваются между людьми, употребляющими каннабис \textbf{часто} и \textbf{редко} %The results are compared between the \textbf{heavy} and \textbf{light} cannabis users
    \end{itemize}
...
Для разработки априорного распределения исследователи совместили много источников  информации%To develop a prior researchers combined many sources of information
    \begin{enumerate}
        \item Знания имевшиеся до сбора данных %Knowledge before seeing any data
        \visible<2->{
        \begin{itemize}
            \item Практический диапазон для метрики SOPT и темпов роста%Practical range for SOPT measure and growth rates
        \end{itemize}}
        \item Результаты прошлых исследований:%Prior research results
        \visible<3->{
        \begin{itemize}
            \item размер эффекта от употребления марихуаны был смешан с другими заболеваниями, или о нём не было данных %effect size of cannabis use was mixed with other diseases or had missing information
            \item "в 13 из 693 статей была полезная информация"%"13 out of 693 articles yielded useful information"
        \end{itemize}}
        \item Экспертнон мнение%Expert knowledge
        \visible<4->{
        \begin{itemize}
            \item Прошлые исследования были изучены исследователями %Prior research was reviewed by experts
            \item Связь заболеваний и поведения с употреблением марихуаны %Relation of diseases and behaviour to cannabis use
        \end{itemize}}
        \item Ограничения %Constraints
        \visible<5->{
        \begin{itemize}
            \item Наклон SOPT development rate скорее положительный, чем отрицательный %Slope (SOPT development rate) is more positive than negative
        \end{itemize}}
        \item Свойства модели %Model properties
        \visible<6->{
        \begin{itemize}
            \item Знак квадратичного члена %Sign of the quadratic term
        \end{itemize}}
    \end{enumerate}
\end{column}
...
\begin{enumerate}
    ...
    \item Априорное распределение неверно специфицировано%Prior is incorrectly specified
    \visible<4->{
    \begin{itemize}
...
\begin{columns}
    \begin{column}{0.5\linewidth}
        Вы продаёте орехи. Вы хотите продать больше орехов!
        Как увеличить объёмы продаж?
        \begin{itemize}
            \item увеличить вероятность покупки%increase purchase probability
            \visible<2->{
            \begin{itemize}
                \item Сделать баннер о здоровой еде%Create a banner about healthy food
                \item Добавить баннер с рецептами%Add a banner with recipes

...
\title[Прикладные байесовские методы]{Прикладные байесовские методы}
...
\begin{figure}
    ...
    \caption{интегрирование Leapfrog}
    % \label{fig:my_label}
\end{figure}
\end{column}
\end{columns}
...
\begin{frame}{Настраиваем иерархии в априорных распределениях}
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Поправляем отклонения, если нужно -- повторно подбираем параметры
        \end{itemize}
        }
    \end{enumerate}
\visible<4>{
